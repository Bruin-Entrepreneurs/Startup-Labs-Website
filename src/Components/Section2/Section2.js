...
class Section2 extends Component {
	state = {
		...
		companyObjArray: [
			...
			{name: "Need", backgroundColor: 'rgb(240, 118, 143)', animation: "", text: "Need is a peer-to-peer, hyperlocal, electric-vehicle-driven delivery platform. Their vision is to create a truly peer-to-peer delivery platform that capitalizes on students’ hyperlocal knowledge of university campuses; initially targeting niche markets inaccessible to existing services. By removing unnecessary overhead costs, restructuring the business model, and integrating their open platform, they believe that they can revolutionize the current delivery market."},
